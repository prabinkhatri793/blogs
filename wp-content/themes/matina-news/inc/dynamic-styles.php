...
if ( ! function_exists( 'matina_news_custom_css' ) ) :

    /**
     * function to handle matina_news_head_css filter where all the css relation functions are hooked.
     *
     * @since 1.0.0
     */
    function matina_news_custom_css( $output_css = NULL ) {

        // Add filter matina_news_head_css for adding custom css via other functions.
        $output_css = apply_filters( 'matina_news_head_css', $output_css );

        if ( ! empty( $output_css ) ) {
            $output_css = wp_strip_all_tags( matina_news_minify_css( $output_css ) );
            echo "<!--Matina News CSS -->\n<style type=\"text/css\">\n". $output_css ."\n</style>";
        }
    }

endif;

add_action( 'wp_head', 'matina_news_custom_css', 9999 );

/*-----------------------------------------------------------------------------*/

if ( ! function_exists( 'matina_news_general_css' ) ) :
     ...
     * @since 1.0.0
     */
    function matina_news_general_css( $output_css ) {

        $theme_color                    = get_theme_mod( 'matina_news_primary_theme_color', '#0A71C0' );
        $text_color                     = get_theme_mod( 'matina_news_body_text_color', '#3d3d3d' );
        $link_color                     = get_theme_mod( 'matina_news_link_color', '#0A71C0' );
        $link_hover_color               = get_theme_mod( 'matina_news_link_hover_color', '#8e4d48' );
...
add_filter( 'matina_news_head_css', 'matina_news_general_css' );

/*-----------------------------------------------------------------------------*/

if ( ! function_exists( 'matina_news_top_header_css' ) ) :
     ...
     * @since 1.0.0
     */
    function matina_news_top_header_css( $output_css ) {

        $custom_css = '';
        $bg_color   = get_theme_mod( 'matina_news_top_header_bg_color', '#333' );
...
add_filter( 'matina_news_head_css', 'matina_news_top_header_css' );


/*-----------------------------------------------------------------------------*/

if ( ! function_exists( 'matina_news_header_image_css' ) ) :
     ...
     * @since 1.0.0
     */
    function matina_news_header_image_css( $output_css ) {

        $custom_css = '';

        $header_image               = get_header_image();
        $header_image_position      = get_theme_mod( 'matina_news_header_image_position' );
        $header_image_attachment    = get_theme_mod( 'matina_news_header_image_attachment' );
        $header_image_repeat        = get_theme_mod( 'matina_news_header_image_repeat' );
        $header_image_size          = get_theme_mod( 'matina_news_header_image_size' );
        ...
        if ( has_header_image() && ! empty( $custom_css ) ) {
            $output_css .= '/*  */#masthead{'. $custom_css .'}';
        }
...
add_filter( 'matina_news_head_css', 'matina_news_header_image_css' );

if ( ! function_exists( 'matina_news_page_title_background_css' ) ) :

    /**
     * function to manage the page title background color.
     *
     * @since 1.0.0
     */
    function matina_news_page_title_background_css( $output_css ) {

        $page_title_style = get_theme_mod( 'matina_news_page_title_style', 'default' );
        if ( 'background-color' !== $page_title_style ) {
            return $output_css;
        }
        ...
        $bg_color       = get_theme_mod( 'matina_news_page_title_bg_color', '#3d3d3d' );
        ...
        //apply all custom css to the mt-page-header class
        if ( ! empty( $custom_css ) ) {
            $output_css .= '/* Page Title CSS */.mt-page-header.background-color-page-header { '. $custom_css .' }';
        }
...
add_filter( 'matina_news_head_css', 'matina_news_page_title_background_css' );

/*-----------------------------------------------------------------------------*/

if ( ! function_exists( 'matina_news_typography_css' ) ) :
     ...
     * @since 1.0.0
     */
    function matina_news_typography_css( $output_css ) {
...
add_filter( 'matina_news_head_css', 'matina_news_typography_css' );